...
function turnOffSR(){
  ...
  startGame.style.cssText = "background-color: #30394C; color: #fff;"
...
function turnOffSP(){
  ...
  revealSketch.style.cursor = "default";
  var restartGame = document.getElementById('restartGame');
  restartGame.style.cssText = "background-color: #30394C; color: #fff;";
...
function turnOffPR(){
  var revealSketch = document.getElementById('revealSketch');
  revealSketch.style.cssText = "background-color: #30394C; color: #fff;";
...
function revealSketch(){
  var sketch = document.getElementById('sketch-holder');
